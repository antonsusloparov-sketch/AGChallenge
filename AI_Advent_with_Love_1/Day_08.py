...
'''
Все города России (пример - убийца):
...
sys_prompt_12 = (f'Ты учитель географии. Проведи опрос ученика на знание городов России.'
...
print("День № 8")
print("==================================================================")
result = giga.tokens_count(input_=[sys_prompt_12], model="GigaChat-2-Pro")
